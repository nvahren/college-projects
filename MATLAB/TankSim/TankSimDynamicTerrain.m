    ...
    if turn == 1
        ...
        while turnComplete == 0
            ...
            elseif strcmpi(action,'fire')
                ...
                yTerrain(round(xImpact)) = yTerrain(round(xImpact))-0.1;
                yTerrain(round(xImpact)+1) = yTerrain(round(xImpact))-0.075;
                yTerrain(round(xImpact)+2) = yTerrain(round(xImpact))-0.05;
                yTerrain(round(xImpact)-1) = yTerrain(round(xImpact))-0.075;
                yTerrain(round(xImpact)-2) = yTerrain(round(xImpact))-0.05;
                plot(xTerrain,yTerrain,'k-','LineWidth',2)
                hold on
